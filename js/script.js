...
$(document).ready(function(){
	setTimeout( function(){
        ...
        $(".typewrite span").typed({
            strings: ["Full Stack Developer", "HTML ", "CSS ", "Bootstrap", "JavaScript", "jQuery", "AJAX", "Firebase", "API", "NodeJS", "Express", "GitHub", "Heroku", "MySQL", "Handlebars", "ORM's", "MongoDB", "React", "React-Native", "Full Stack Developer" ],
            typeSpeed: 50,
            backDelay: 500,
            loop: false,
